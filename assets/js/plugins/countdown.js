...
seconds=eventDate-currentDate;days=Math.floor(seconds/(60*60*24));seconds-=days*60*60*24;hours=Math.floor(seconds/(60*60));seconds-=hours*60*60;minutes=Math.floor(seconds/60);seconds-=minutes*60;if(days==1){thisEl.find(".timeRefDays").text("gün");}else{thisEl.find(".timeRefDays").text("gün");}
if(hours==1){thisEl.find(".timeRefHours").text("saat");}else{thisEl.find(".timeRefHours").text("saat");}
if(minutes==1){thisEl.find(".timeRefMinutes").text("dakika");}else{thisEl.find(".timeRefMinutes").text("dakika");}
if(seconds==1){thisEl.find(".timeRefSeconds").text("saniye");}else{thisEl.find(".timeRefSeconds").text("saniye");}
